...
<template>
  <section class="s6 relative overflow-hidden">
    <img class="bg pc" src="./s5/bg.webp" alt="bg" />
    <img class="bg mb" src="./s5/bgm.webp" alt="bg" />
    <div class="container relative">
      <div class="title font-['Noto_Sans_TC']">
        ...
        <p v-if="!isMobile" data-aos="fade-up" data-aos-delay="400">
          一次次車道開啟，家知道你回來，一滴滴純淨的水，是家的輕柔問候<br />每一個智慧細節，讓您安心依靠，感受美好
        </p>
        <p v-else data-aos="fade-up" data-aos-delay="400">
          一次次車道開啟，家知道你回來<br />一滴滴純淨的水，是家的輕柔問候<br />每一個智慧細節，讓您安心依靠，感受美好
        </p>
      ...
      <div class="slider-wrapper" data-aos="fade">
        <swiper class="concept-swiper" :effect="'creative'" :creativeEffect="isMobile
          ? {
            prev: {
          ...
          : {
            prev: {
              translate: ['-80%', 0, -510], // 電腦版維持原樣
            },
            next: {
              translate: ['80%', 0, -510],
            }
          }
          " :grabCursor="true" :slidesPerView="'auto'" :centeredSlides="true" :loop="true" :speed="1000"
